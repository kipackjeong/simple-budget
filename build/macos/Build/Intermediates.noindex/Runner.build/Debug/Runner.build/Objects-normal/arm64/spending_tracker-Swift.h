...
#ifndef SPENDING_TRACKER_SWIFT_H
#define SPENDING_TRACKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="spending_tracker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC16spending_tracker11AppDelegate")
...
SWIFT_CLASS("_TtC16spending_tracker17MainFlutterWindow")
